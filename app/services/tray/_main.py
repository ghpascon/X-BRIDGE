...
class TrayManager:
    ...
    def _build_menu(self):
        ...
        widgets.append(pystray.MenuItem("Devices", devices_menu))  # <-- submenu como segundo argumento
    ...
    def _get_devices_submenu(self):
        ...
        for device in devices:
            ...
            submenu = pystray.Menu(
                ...
                pystray.MenuItem(f"Connected: {'Yes' if connected else 'No'}", lambda: None, enabled=False),
                pystray.MenuItem(f"Reading: {'Yes' if reading else 'No'}", lambda: None, enabled=False),
